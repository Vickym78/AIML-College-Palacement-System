...
function AddInternship() {
  document.title = 'APMS | Add Internships';
  ...
  const confirmSubmit = async () => {
    try {
      // ✅ Fix the URL before sending
      if (
        internship?.companyWebsite &&
        !internship.companyWebsite.startsWith("http")
      ) {
        internship.companyWebsite = `https://${internship.companyWebsite}`;
      }
