...
function UpdateJobStatus() {
  document.title = 'APMS | Update Job Application Status';
                    ...
                    <Accordion.Body>
                      <div className="">
                        <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
                          ...
                          {/* joining date */}
                          {
                            isHired === true && (<FloatingLabel controlId="floatingJoiningDate" label="Joining Date">
                            <Form.Control
                              type="date"
                          ...
                          {
                            isHired === true && (<div className="flex flex-col gap-2 justify-center items-center">
                              ...
                              <div className="cursor-pointer w-fit flex gap-1 justify-between items-center">
                                ...
                                >
                                 <a
                                  ...
                                  href={applicant?.offerLetter}  // Use the direct Cloudinary URL
                                >
                                  {eyeIsHover ? (
