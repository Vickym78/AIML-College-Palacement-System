...
function SendNotice() {
  document.title = 'APMS | Send Notice';

  const navigate = useNavigate();
  const [loading, setLoading] = useState(true);  // Loading state for initial fetch

  const [data, setData] = useState({});          // Form data state
  const [attachment, setAttachment] = useState(null); // Attachment file state
                ...
                <div className="col-span-2">
                  <Form.Group controlId="formFile" className="mt-2">
                    ...
                    <Form.Control 
                      ...
                      accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.txt" // Accept common file types
                    />
                  </Form.Group>
                </div>
              </div>
