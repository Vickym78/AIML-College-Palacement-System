...
function AllCompany() {
  document.title = 'APMS | All Company';
              ...
              <Table striped bordered hover className='bg-white my-6 rounded-lg shadow w-full text-base max-sm:text-sm max-sm:my-3'>
                <thead>
                  <tr>
                    ...
                    <th style={{ width: '17%' }}>Company Type Level</th>
                  ...
                  {companys?.length > 0 ? (
                    companys?.map((company, index) => (
                      <tr key={company?._id}>
                        ...
                        <td>
                          {company?.companyType === "Dream" && (
                            <span className='bg-green-500 text-white px-2 py-1 rounded'>{company?.companyType}</span>
                          )}
                          {company?.companyType === "Non-Dream" && (
                            <span className='bg-orange-500 text-white px-2 py-1 rounded'>{company?.companyType}</span>
                          )}
                          {/* {company?.companyType === "Hard" && (
                            <span className='bg-red-500 text-white px-2 py-1 rounded'>{company?.companyType}</span>
                          )} */}
                        </td>
                        <td>
                          {jobs.length
