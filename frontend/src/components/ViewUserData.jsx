                      ...
                      <div className="grid">
                        <div className="grid grid-flow-col">
                          <div className="space-y-4">
                            ...
                            {/* Add View Offer Letter option if present */}
        {placement?.isPlaced && jobDetail?.applicants?.find(a => a.studentId === userId)?.offerLetter && (
          <div>
            {/* <span className="text-gray-700 font-bold">Offer Letter: </span> */}
            <a 
              href={jobDetail.applicants.find(a => a.studentId === userId).offerLetter} 
              target="_blank" 
              rel="noopener noreferrer"
              className="no-underline bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded transition-colors duration-200 inline-block"
            >
             <i className="fa-regular fa-eye px-2" />
              View Offer Letter
            </a>
